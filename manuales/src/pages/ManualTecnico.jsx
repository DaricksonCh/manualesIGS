    ...
    <div className="bg-gray-100 flex items-center justify-center text-lg leading-10">
      <div className="container p-8 w-[60%]">
        ...
        <div className="container mx-auto p-8">
          <h2 className="text-2xl font-semibold mb-4">Diccionario de Datos</h2>
          <table className="min-w-full bg-white border border-gray-300">
            <thead>
              <tr className="bg-gray-200">
                <th className="py-2 px-4 border">Propiedad</th>
            ...
            <tbody>
              <tr>
                <td>Proveedores</td>
                <td>Arreglo de proveedores</td>
              </tr>
              <tr>
                <td>sortedProveedores</td>
                <td>Arreglo de proveedores ordenado por ID</td>
              </tr>
              <tr>
                <td>selectedProveedorData</td>
                <td>Datos del proveedor seleccionado para edición</td>
              </tr>
              <tr>
                <td>validacionExitosa</td>
                <td>Mensaje de validación exitosa</td>
              </tr>
              <tr>
                <td>registrarProveedor</td>
                <td>Registra un nuevo proveedor en el servidor</td>
              </tr>
              <tr>
                <td>listarProveedor</td>
                <td>Obtiene la lista de proveedores desde el servidor</td>
              </tr>
              <tr>
                <td>eliminarProveedor</td>
                <td>Elimina un proveedor por ID desde el servidor</td>
              </tr>
              <tr>
                <td>editarProveedor</td>
                <td>Obtiene y muestra los datos de un proveedor para su edición</td>
              </tr>
              <tr>
                <td>buscarProveedor</td>
                <td>Busca y muestra un proveedor por ID</td>
              </tr>
              <tr>
                <td>actualizarProveedor</td>
                <td>Actualiza los datos de un proveedor en el servidor</td>
              </tr>
              <tr>
                <td>limpiarModal</td>
                <td>Restaura el estado del modal a su estado inicial</td>
              </tr>
              <tr>
                <td>aplicaFechaCaducidad</td>
                <td>Indica si se aplica la fecha de caducidad</td>
              </tr>
              <tr>
                <td>aplicaFechaCaducidad2</td>
                <td>Indica si se aplica la fecha de caducidad en la segunda instancia</td>
              </tr>
              <tr>
                <td>handleCheckboxChange</td>
                <td>Maneja el cambio en el estado del checkbox para la fecha de caducidad</td>
              </tr>
              <tr>
                <td>handleCheckboxChange2</td>
                <td>Maneja el cambio en el estado del checkbox para la fecha de caducidad en la segunda instancia</td>
              </tr>
              <tr>
                <td>listarMovimiento</td>
                <td>Obtiene la lista de movimientos desde el servidor y actualiza la tabla</td>
              </tr>
            </tbody>
          </table>
        </div>
